...
class ViewConfirmCart {
	...
	public function render($datas)
	{
		...
		$html = '<div class="container"><div class="row-fluid"><div class="span12"><div class = "span12"><form action="/order/address" method="POST" >';
		$html .= '<span style="color:#FFFFFF;">输入客户手机号: </span><input type="text" name = "phone_no" > <button class="btn btn-large btn-primary" type="submit">订购</button>';
