...
class ViewFinder {
	...
	public function render($datas)
	{
		...
		$html .='<div class="well"><h3>'.$datas['date'].'</h3></div>';
		$html .='<div><ul class="pager">';
		if(isset($datas['hasPrev']))
		{
			$html .='<li class="previous"><a href="/finder/'.$datas['date'].'/'.intval($datas['hasPrev']).'">Prev</a></li>';
		}
		if(isset($datas['hasNext']))
		{
			$html .='<li class="next"><a href="/finder/'.$datas['date'].'/'.intval($datas['hasNext']).'">Next</a></li>';
		}
		$html .='</ul></div>';
